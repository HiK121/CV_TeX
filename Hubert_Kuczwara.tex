...
\begin{twenty} % Environment for a list with descriptions
    ...
    \begin{itemize}
				\item Programowanie sterowników PLC (TIA Portal, Studio5000)
				\item Testowanie stanowisk, szaf, urządzeń - I/O check (TIA Portal, Studio5000)
				\item Uruchamianie i testowanie urządzeń (TIA Portal)
