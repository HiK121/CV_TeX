...
\pltrue	%polish version of twentysecondcv
%----------------------------------------------------------------------------------------
...
\textbf{Programowanie PLC:}/,_, Siemens:/2, {TIA Portal$,$}/2,  {STEP7}/1,/,Allen-Bradley:/1, {Studio5000 }/,_, 
\textbf{Programowanie skryptowe:}/,_,{MS Visual Studio$($}/2, {C/C++$,$}/1, {Python$)$,}/2,Matlab/2,,_,
\textbf{CAD:}/,_, CATIA/2}
%------------------------------------------------
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{obecnie- -10.2014}{{Budowa i~Eksploatacja Maszyn}}{{Wydział~Mechaniczny} {Politechnika~Wrocławska}}{{studia doktoranckie}\\{\emph{temat przewodu:}
